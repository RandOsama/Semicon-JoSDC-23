...
create_generated_clock -name {pll1_inst|altpll_component|auto_generated|pll1|clk[0]} -source [get_pins {pll1_inst|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50/1 -multiply_by 53 -divide_by 50 -master_clock {MAX10_CLK1_50} [get_pins {pll1_inst|altpll_component|auto_generated|pll1|clk[0]}] 
